...
setHTMLElemAttribute('href', 'http://sathvick.com', 'info_button', false);
...
operateAnimation('PLAY', 'shadow_catcher', 0, 100, 'LoopRepeat', 1, function() {}, false);

volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('mac', false, false, [0,1,2], false, function(event) {
    operateAnimation('STOP', 'shadow_catcher', null, null, 'AUTO', 1, function() {}, false);
    playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);
    operateAnimation('PLAY', 'shadow_catcher', 100, 240, 'LoopOnce', 1, function() {
        operateAnimation('PLAY', 'shadow_catcher', 0, 100, 'LoopRepeat', 1, function() {}, false);
    }, false);
}, function(event) {});
...
checkARMode(function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
        enterARMode('ORIGIN', true, function() {
            changeVis(['GROUP', 'mac_group'], false);
            ...
            setObjTransform('Armature', false, 'position', [1, 1, 1], false);
            updateTextObj('scale_percentage', '100%');
        }, function() {
            changeVis(['GROUP', 'mac_group'], true);
            changeVis('prompt_move_around', false);
            setObjTransform('Armature', false, 'position', createVector(0, 0, 0), false);
            setHTMLElemStyle('display', 'block', 'enter_AR_button', false);
            changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'ready_button', 'edit_button', 'scale_percentage'], false);
        }, function() {
            show_warning('warning_could_not_enter_AR');
        });
    });
}, function() {
    setHTMLElemAttribute('href', exportToUSDZ('mac'), 'enter_AR_button', false);
    setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
    setHTMLElemAttribute('download', 'mac.usdz', 'enter_AR_button', false);
}, function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], false, function(event) {
    ...
    setObjDirection('Armature', getObjDirection('Camera', 'XYZ'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('Armature', 'XY', 'WORLD', '!/m9+M,~+M53j.Ne?iv6', '#CXw+H]+X_x@ThDQC!5X');
}, function(event) {}, '#CXw+H]+X_x@ThDQC!5X');
...
registerOnDrag('drag_rotate', false, [0,1,2], function(event) {}, function(event) {
    dragRotateAdv('Armature', 'Z', 'WORLD', 'oIg*$lm9Yy)cFesB(O^2', 'M{4iz1pQ.R[(P,uBBfdj');
}, function(event) {}, 'M{4iz1pQ.R[(P,uBBfdj');

registerOnDrag('drag_scale', false, [0,1,2], function(event) {}, function(event) {
    dragScale('Armature', 'Z', '0-LEYW=KTO5IKknb*98,', '11n(0^q$7BAU#Q*6L._6');
    dragScale('Armature', 'Y', 'a.WkAR2H7]@4N/}g9wG}', '11n(0^q$7BAU#Q*6L._6');
    dragScale('Armature', 'X', 'RN`_2|Yt)*_XsCySZ7|T', '11n(0^q$7BAU#Q*6L._6');
    updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('Armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function(event) {}, '11n(0^q$7BAU#Q*6L._6');
